...
public class Image {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ImagesClassificatorSerializator.writeInputDataToFile(arrTemplates, "learnClass_a.net");
        arrTemplates = ImagesClassificatorSerializator.getInputDataFromFile("learnClass_a.net");
